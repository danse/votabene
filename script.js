...
var Chart, excluded, height, indexUpdateSub, lineClassMap, log, padding, responsibleUpdateSub, width;
...
indexUpdateSub = function(event) {
  ...
  return $('div#submessage').attr('class', cl);
};
...
Chart = (function() {
  ...
  Chart.prototype.draw = function(index) {
    ...
    this.axisSelection = this.svg.append('g').attr('class', 'axis').attr('id', index.description).attr('transform', 'translate(' + (20 + Number(padding)) + ', 0)');
